	...
	function showAddQuestion() {
		...
		var res = window
				...
				.open(
						...
						"jsp/addTest.jsp?csId=${course.csId }&csName=${course.csName}&stage=${course.stage }&major=${course.major}",
	...
	function showUpdateQuestion(qid) {
		...
		var res = window
				...
				.open(
						...
						"test/test_getWrittenTestById?csId=${course.csId }&csName=${course.csName}&writtenTest.qid="+qid,
...
<body>
	...
	<div>
		...
		<h3 align="center"><s:property value="course.csName"/>笔试试题列表</h3>
		...
		<form
			...
			<input type="file" name="testfile"> <input type="submit"
	...
	<fieldset id="marginTop">
		...
		<div align="right" id="marginTop">
			...
			<a
				...
				href="test/test_getWrittenList?course.csId=${course.csId }&course.csName=${course.csName}&pageIndex=1">首页</a>&nbsp;

			<a

				href="test/test_getWrittenList?course.csId=${course.csId }&course.csName=${course.csName}&pageIndex=${pageBean.preIndex }">上一页</a>&nbsp;

			<a

				href="test/test_getWrittenList?course.csId=${course.csId }&course.csName=${course.csName}&pageIndex=${pageBean.nextIndex }">下一页</a>&nbsp;

			<a

				href="test/test_getWrittenList?course.csId=${course.csId }&course.csName=${course.csName}&pageIndex=${pageBean.totalPage }">末页</a>
