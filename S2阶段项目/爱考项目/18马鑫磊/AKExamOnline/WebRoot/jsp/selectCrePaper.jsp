...
function getQuestions2(_this) {
var qtotal  =Number($("#qtotal").val());
...
var url = "${basePath}test/test_getTestList";
var csId = $("#csId").val();
...
tr.append("<td><input type='checkbox' name='question' value='"+data.items[i].qid+"' onchange='getQuestions2(this)' /></td>");
tr.append("<td>"+i+"</td>");
