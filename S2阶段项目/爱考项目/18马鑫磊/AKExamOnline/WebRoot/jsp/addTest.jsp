...
<body>
	...
	<div class="marginLayout">
		...
		<form action="test/test_addWrittenTest" method="post" name="formAddQuestion"
			...
			<input type="hidden" name="course.major" value="${param.major}">
			...
			<table class="marginLayout">
				...
				<tr>
					...
					<td>
						...
						<select id="qtype" name="writtenTest.qtype" onchange="changeOptionType()">
				...
				<tr>
					...
					<td>
						...
						<textarea rows="3" cols="30" name="writtenTest.qtitle" id="qTitle"></textarea>
				...
				<tr>
					...
					<td>
						...
						<input type="radio" class="options" name="writtenTest.answer" value="A" checked="checked">A

						<input class="textWidth" type="text" name="writtenTest.optionA" id="optionA">

						<br />

						<input type="radio" class="options" name="writtenTest.answer" value="B">B

						<input class="textWidth" type="text" name="writtenTest.optionB" id="optionB">

						<br />

						<input type="radio" class="options" name="writtenTest.answer" value="C">C

						<input class="textWidth" type="text" name="writtenTest.optionC" id="optionC">

						<br />

						<input type="radio" class="options" name="writtenTest.answer" value="D">D

						<input class="textWidth" type="text" name="writtenTest.optionD" id="optionD">
				...
				<tr>
					...
					<td>
						...
						<input class="textWidth" type="text" name="writtenTest.chapter" id="chapter">
