package com.qhit.lh.g4.jack.exam.bjgl.bean;

import java.util.Date;
import java.util.HashSet;
import java.util.Set;

import com.qhit.lh.g4.jack.exam.common.bean.Student;
...
public class Classinfo implements java.io.Serializable {
	...
	private Set<PaperClass> paperClasses =new HashSet<PaperClass>();
	// Constructors
