...
<body onload="setDefaultOptions()">
	<div class="marginLayout">
		<form action="question/question_updatewrittenTest" method="post" name="formAddQuestion"
			...
			<table class="marginLayout">
				...
				<tr>
					...
					<td>
						<select id="qtype" name="writtenTest.qtype" onchange="setDefaultOptions()">
							<s:if test="writtenTest.qtype == '单选'">
				...
				<tr>
					...
					<td>
						<textarea rows="3" cols="30" name="writtenTest.qtitle" id="qTitle">
							${writtenTest.qtitle }
						</textarea>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="radio" class="options" name="writtenTest.answer" value="A">A
						<input class="textWidth" type="text" name="writtenTest.optionA" id="optionA" value="${writtenTest.optionA }">
						<br />
						<input type="radio" class="options" name="writtenTest.answer" value="B">B
						<input class="textWidth" type="text" name="writtenTest.optionB" id="optionB" value="${writtenTest.optionB }">
						<br />
						<input type="radio" class="options" name="writtenTest.answer" value="C">C
						<input class="textWidth" type="text" name="writtenTest.optionC" id="optionC" value="${writtenTest.optionC }">
						<br />
						<input type="radio" class="options" name="writtenTest.answer" value="D">D
						<input class="textWidth" type="text" name="writtenTest.optionD" id="optionD" value="${writtenTest.optionD }">
						<br />
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="writtenTest.degree">
							<s:if test="writtenTest.degree == '简单'">
								<option value="简单" selected="selected">简单</option>
								<option value="一般">一般</option>
								<option value="困难">困难</option>
							</s:if>
							<s:elseif test="writtenTest.degree == '一般'">
				...
				<tr>
					...
					<td>
						<input class="textWidth" type="text" name="writtenTest.chapter" id="chapter" value="${writtenTest.chapter }">
					</td>
				</tr>
				<tr>
