...
<html>
  <head>
    ...
    <title>My JSP 'testManage.jsp' starting page</title>
...
.group {
  ...
  <body>
   <!-- 
	...
	<s:form action="/test/test_getCourseInfo" method="post" theme="simple">
	...
	<s:iterator value="listCourses" var="course">
		...
		<div align="center" class="group">
			...
			<a href="test/test_getWrittenList?course.csId=${course.csId }&course.csName=${course.csName}&course.stage=${course.stage }&&course.major=${course.major }" target="manFrame">
